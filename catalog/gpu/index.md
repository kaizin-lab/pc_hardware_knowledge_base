...
| Файл | Модель | VRAM | TDP | Цена (₽) | Позиционирование |
|---|---|---|---|---|---|
| `nvidia-rtx-5060.md` | RTX 5060 | 8 GB | 145W | ~25 000 | 1080p High |
...
| `nvidia-rtx-4070.md` | RTX 4070 | 12 GB | 200W | [draft] | 1440p энергоэффективность |
