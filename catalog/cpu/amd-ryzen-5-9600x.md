...
9600X продолжает традицию 65-ваттных 6-ядерников AM5: iGPU, боксовый кулер, умеренное энергопотребление. Главный вопрос: стоит ли переплачивать за Zen 5 относительно проверенного Ryzen 5 7600?
...
- Кулер в коробке: Wraith Stealth
...
65W TDP — холодный процессор. Wraith Stealth справляется, но на грани. Рекомендуется замена на башенный кулер за 1 500–2 500 ₽:

- Wraith Stealth: Cinebench ~78–82°C, шумно
...
- Кулер: Wraith Stealth (из коробки)
- RAM: 32 GB DDR5-6000 CL30
- GPU: RTX 5060 Ti
