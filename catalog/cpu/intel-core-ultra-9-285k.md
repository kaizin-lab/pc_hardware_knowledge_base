...
specs:
  ...
  base_clock_e: "2.6 GHz (all-core turbo 3.2 GHz)"
...
- **AI-нагрузки (NPU):** NPU на 13 TOPS ускоряет Windows Studio Effects и локальный AI-инференс. На момент выхода Arrow Lake (осень 2024) AMD аналога не имела в настольном сегменте.
...
- **Idle / веб-сёрфинг:** 45–65W (чиплетная архитектура с отдельным тайлом SoC и NPU заметно повышает потребление в простое по сравнению с монолитами; может снижаться отключением C-states для NPU или обновлениями микрокода)
