...
engineering_notes: "Hyper-Threading УБРАН в Arrow Lake. 24C/24T — не ошибка. Gaming regression на старте vs 14900K — исправлен комплексно: обновлением микрокода, патчами планировщика Windows (Thread Director 2.0) и адаптацией игровых движков под tile-топологию кэша. Встроенный Intel Arc Graphics (Xe-LPG) с аппаратным AV1 encode. LGA1851 — новый сокет, несовместим с LGA1700. TSMC N3B compute tile — первый Intel на внешнем техпроцессе. CUDIMM поддержка — DDR5 с встроенным clock driver."
