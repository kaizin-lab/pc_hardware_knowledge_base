...
Позиционируется Intel против AMD Ryzen 9 9900X (12C/24T, 120W). В многопотоке 265K выигрывает за счёт большего количества ядер (20 против 12), в играх — проигрывает из-за архитектурных особенностей Arrow Lake. QuickSync и NPU — сильные дифференциаторы, которых у AMD нет.
...
- **SoC tile (TSMC N6):** контроллер DDR5, PCIe 5.0, NPU 13 TOPS.
- **GPU tile (TSMC N6):** Intel Graphics Xe-LPG (4 Xe-ядра, до 2.0 GHz).
...
- TJmax: 105°C
- iGPU: Intel Graphics (4 Xe-LPG, 2.0 GHz) — QuickSync
- NPU: Intel AI Boost (13 TOPS)
- Кулер в коробке: нет
...
- **Для сравнения — i7-14700K (253W):** 200–280W в играх. 265K потребляет **вдвое меньше** при сопоставимой производительности
...
**Вывод:** 265K и 9900X — прямые конкуренты. Intel выигрывает в видеомонтаже (QuickSync) и AI. AMD — в играх и долговечности платформы. При равной цене (что редкость в РФ) — выбор за сценариями использования.
...
- Рабочие станции с AI-нагрузками: NPU 13 TOPS для локального инференса
