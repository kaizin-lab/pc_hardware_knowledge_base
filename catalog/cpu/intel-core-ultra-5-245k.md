...
По сути — это процессор для создателей контента начального уровня: QuickSync для видеомонтажа, NPU для AI-фильтров, 14 ядер для многозадачности. В играх — не рекордсмен, но достаточен для любого гейминга на 1440p и 4K.
...
- TJmax: 105°C
- iGPU: Intel Graphics (4 Xe-LPG, 1.9 GHz) — QuickSync
- NPU: 13 TOPS
- Кулер в коробке: нет
...
- Макс. объём: 192 GB
- PCIe: 20 линий CPU (16× 5.0 + 4× 4.0)
...
- Пользователи со смешанным профилем: игры + работа с фото/видео + AI
- Сборщики, входящие в LGA1851 с прицелом на апгрейд до 285K в будущем
- Те, кто ценит тишину и холод: 125W на воздухе — идеально
- Пользователи с AI-сценариями: NPU для Windows Studio Effects
